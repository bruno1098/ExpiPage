...
const footerLinks = {
  company: [
    ...
    { label: 'Plataforma', href: '#services' },
  ...
  social: [
    { label: 'Instagram', href: 'https://www.instagram.com/_experienceia_/', icon: Instagram },
    { label: 'LinkedIn', href: 'https://www.linkedin.com/company/experienceia', icon: Linkedin },
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            >
              ...
              <span className="text-2xl font-bold">ExperienceIA</span>
            </motion.div>
        ...
        >
          <p className="text-muted-foreground text-sm">
            © {new Date().getFullYear()} ExperienceIA. Todos os direitos reservados.
          </p>
        </motion.div>
      </div>
    </footer>
