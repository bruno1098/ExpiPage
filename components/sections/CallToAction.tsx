        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Pronto para elevar a experiência do seu hóspede?</span>
            </motion.div>
            ...
            <p className={cn(
              ...
              Entre em contato agora e veja como a Expi pode transformar dados em ações estratégicas.
            </p>
