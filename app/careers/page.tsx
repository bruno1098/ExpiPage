...
const openings = [
  // Tech
  {
    ...
    jobs: [
      {
        title: "Desenvolvedor IA/ML",
        department: "Tecnologia",
        location: "São Paulo/Remoto",
        type: "CLT",
        description: "Buscamos desenvolvedores apaixonados por IA para evoluir nossos modelos de análise de sentimento e classificação para hotelaria.",
        requirements: [
          "Experiência com Python e frameworks de ML",
          "Conhecimento em NLP e análise de sentimento",
          "Experiência com TensorFlow ou PyTorch",
          "Vivência em processamento de linguagem natural",
      ...
      },
      {
        ...
        location: "São Paulo",
        type: "CLT",
        description: "Lidere o desenvolvimento de features que transformam feedback em insights acionáveis para hotéis.",
        requirements: [
          "Experiência mínima de 3 anos em gestão de produto",
          "Conhecimento do setor hoteleiro é um plus",
      ...
      },
      {
        ...
        location: "São Paulo/Remoto",
        type: "CLT",
        description: "Ajude hotéis a maximizar o valor da Expi, garantindo sucesso e crescimento dos clientes.",
        requirements: [
          "Experiência em Customer Success ou vendas B2B",
          "Conhecimento do setor hoteleiro",
      ...
      },
      {
        ...
        location: "Remoto",
        type: "PJ",
        description: "Construa pipelines robustos para ingestão e processamento de dados de avaliações multi-canal.",
        requirements: [
          "Experiência com pipelines de dados em larga escala",
          "Conhecimento em Apache Kafka, Spark",
        ...
        <div className="container relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                Junte-se à <span className="text-gradient-animated">Expi</span>
              </motion.p>
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                Revolucione a hotelaria conosco. Trabalhe com IA aplicada ao setor que mais cresce no Brasil.
              </motion.p>
            </div>
