        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              Estamos prontos para mostrar como a Expi transforma feedbacks em decisões.
            </p>
          </motion.div>
        </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="mailto:experienceia1@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="https://www.linkedin.com/company/experienceia" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                      /company/experienceia
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="https://www.instagram.com/_experienceia_" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                      @experienceia
                    </a>
                  </div>
                </motion.div>
