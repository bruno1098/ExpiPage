...
const sections = [
  {
    ...
    content: `Ao acessar e utilizar a plataforma Expi, você concorda expressamente com estes Termos de Uso. É fundamental ler atentamente todas as condições aqui estabelecidas. Caso não concorde com qualquer disposição, recomendamos não utilizar nossa plataforma.

    1.1. Estes termos constituem um acordo legal entre você e a ExperienceIA.
  ...
  },
  {
    ...
    content: `Para utilizar a Expi, você deve:

    2.1. Ter capacidade legal para contratar.
    2.2. Representar um estabelecimento hoteleiro legalmente constituído.
    2.3. Fornecer informações verdadeiras e atualizadas.
    2.4. Manter a confidencialidade de suas credenciais de acesso.
    2.5. Notificar imediatamente qualquer uso não autorizado de sua conta.`
  },
  {
    icon: Scale,
  ...
  },
  {
    ...
    content: `4.1. Todo o conteúdo da plataforma Expi é protegido por direitos autorais.
    4.2. É proibida a cópia, modificação ou distribuição sem autorização.
    4.3. Os algoritmos de IA e modelos permanecem propriedade da ExperienceIA.
    4.4. Os dados inseridos pelo cliente permanecem de sua propriedade.
    4.5. Relatórios e insights gerados ficam disponíveis durante a vigência do contrato.`
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    content: `6.1. A ExperienceIA não se responsabiliza por:
